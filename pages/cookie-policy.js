  ...
  render() { 
    ...
    return (
      <section className={`relative w-full overflow-hidden light-section-theme`}>
        <Head>
          <title>Cookie Policy - {defaultMetaTitle}</title>
          <link rel="canonical" href={`${url}cookie-policy`}/>
          <meta name="title" content={`Cookie Policy - ${defaultMetaTitle}`} />
          <meta name="description" content={`${metaDescription}`}/>
          <meta property="og:title" content={`Cookie Policy - ${defaultMetaTitle}`} key="title" />
