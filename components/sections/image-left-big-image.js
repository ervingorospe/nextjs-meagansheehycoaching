...
class ImageLeftBigImage extends React.Component {
  constructor(props) {
    super(props);
  }
  state = {  }
            ...
            {/* image */}
            {
              ...
              
              {
                !_.get(fields, 'video') && _.get(fields, 'image') && (
                  <ImageHolder image={fields.image} styles="aspect-w-1 aspect-h-2 overflow-hidden rounded-lg"/>
                )
              }
            </div>
...
export default ImageLeftBigImage;