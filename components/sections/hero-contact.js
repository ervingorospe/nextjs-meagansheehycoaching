    ...
    return (
      <section className={`relative overflow-hidden bg-${fields.backgroundColorClass} light-section-theme ${sectionTheme}`}>
        ...
        <div className={`container relative z-1 max-w-screen-md py-12 md:py-20 lg:py-24 xl:py-28 2xl:py-32 ${this.props.marginTop}`}>
            ...
            {
              fields.embedScript && (
                <div className="lg:block relative w-full max-w-2xl lg:max-w-none mt-6 mx-auto">
                  <div className="relative w-full bg-gray-50 rounded-sm">
                    <div className="px-6 pt-6 min-h-[1250px]">
                      <div dangerouslySetInnerHTML={{__html: this.state.embedElement}}/>
                      <Script
                        id="form-script"
                        strategy="afterInteractive"
                        dangerouslySetInnerHTML={{
                          __html: eval(`${this.state.embedScript}`),
                        }}
                      />
                    </div>
